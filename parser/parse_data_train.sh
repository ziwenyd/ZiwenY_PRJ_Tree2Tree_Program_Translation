...
# This shell script is used to perform the workflow on training dataset.
...
# - /parser/data/train_data/js
# - /parser/data/train_data/py

# The generated string-formatted parse tree are placed in the following folder with '_ast_str.txt' postfix.
# - /parser/data/train_data/js_ast_str
# - /parser/data/train_data/py_ast_str
###############
